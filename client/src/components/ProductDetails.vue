    ...
    <div class="container">
      ...
      <div v-else-if="product" class="product-content">
        ...
        <div class="product-info">
          ...
          <div v-if="!auth.isAdmin.value" class="options">
...
<script>
// Simple: ProductDetails — shows product info and allows adding to cart
...
export default {
  ...
  setup() {
    ...
    const isSizeOutOfStock = (size) => (sizeStock.value[size] || 0) === 0
    ...
    const addToCart = async () => {
      ...
      const result = await cart.addItem(product.value.id, selectedSize.value, 1)
