// Simple: initProducts.js — seeds the database with sample products and an admin user.
// Run this with `npm run init` to populate tables for local development.
...
async function initProducts() {
  try {
    ...
    console.log('Admin account created: admin@gmail.com / admin1234')
